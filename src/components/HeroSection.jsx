...
import { Upload, Brain, FileText, Star, Check, ArrowRight, TrendingUp } from "lucide-react"
          ...
          <div className="grid lg:grid-cols-2 grid-cols-1 gap-16 items-center">
            ...
            >
              <motion.h1
                ...
                variants={fadeInUp}
              >
              Optimise your spendings, maximise 
                
                <span className="block text-blue-600 mt-2">your profits</span>
              </motion.h1>

              <motion.p className="text-lg text-slate-500 mb-8 max-w-2xl leading-relaxed" variants={fadeInUp}>
               block text-blue-600 mt-2
              </motion.p>
